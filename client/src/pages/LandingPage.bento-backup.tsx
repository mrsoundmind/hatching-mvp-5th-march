...
export default function LandingPage() {
  ...
  // Override body overflow for scrolling + reset scroll position on mount
  useEffect(() => {
  ...
  // Scroll-triggered reveal for bento section
  useEffect(() => {
  ...
  return (
    <div className="w-full min-h-screen text-foreground font-sans selection:bg-white/20 overflow-x-hidden flex flex-col relative transition-colors duration-1000" style={{ background: '#0A0C13' }}>
      ...
      >
        ...
        {/* Full-screen video — natural framing, no parallax zoom */}
        <video
        ...
        <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
          ...
          <Link href="/login">
            <button className="liquid-glass rounded-full px-5 py-2 text-sm text-white hover:scale-[1.03] transition-transform cursor-pointer">
              Get Started
            </button>
          </Link>
        </nav>
        ...
        {/* Hero copy */}
        <div className="relative z-10 flex flex-col items-center text-center px-6 pt-20 pb-64">
          <h1
            className="animate-fade-rise text-5xl sm:text-7xl md:text-[82px] leading-[0.95] tracking-[-2px] max-w-5xl font-normal text-white"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            Where{' '}
          ...
          <p className="animate-fade-rise-delay text-base sm:text-lg max-w-xl mt-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)' }}>
      ...
      {/* ━━━ UNIFIED BENTO GRID ━━━ */}
      <div className="w-full text-center px-6 pt-24 pb-10 relative z-10 scroll-reveal" style={{ marginTop: '-80px' }}>
        <h2 className="text-4xl md:text-5xl font-normal text-white mb-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
          Your team, built for you.
        </h2>
        <p className="text-white/45 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
          30 AI teammates. Real expertise. Real opinions. Pick who you need, tell them what you're building.
        </p>
      </div>
      <main className="w-full max-w-[1440px] mx-auto px-4 md:px-6 pb-12 relative z-10 flex-1 scroll-reveal">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-[1fr_1fr_1.2fr_1fr_1fr] gap-3" style={{ gridAutoRows: '180px' }}>
          ...
          <div className="lg:col-span-1 lg:row-span-3 flex flex-col min-h-0">
            <div ref={chatRef} className="w-full h-full flex flex-col border-2 border-white/60 shadow-[0_0_80px_rgba(255,255,255,0.05),0_0_0_1px_rgba(255,255,255,0.1)] relative rounded-2xl bg-white/95 dark:bg-[#080A0F]/95 backdrop-blur-xl overflow-hidden">
              ...
              {/* Messages */}
              <div ref={chatScrollRef} className="flex-1 overflow-y-auto px-4 py-4 space-y-5 scrollbar-hide z-10 bg-transparent">
                    ...
                    <motion.div key={msg.id}
                      ...
                      {msg.role === "user" ? (
                        ...
                        <div id={msg.uspId ? `bubble-${msg.uspId}` : undefined}
                          className={`max-w-[95%] border bg-slate-50 dark:bg-[#0A0C13] p-4 relative overflow-hidden group shadow-xl transition-all duration-700 rounded-xl rounded-tl-sm ${(msg.uspId && activePanel === msg.uspId) ? getColorClasses(USPS.find(u => u.id === msg.uspId)!.color).border : 'border-slate-200 dark:border-white/10'}`}>
                          <div className="absolute top-0 left-0 w-1 h-full bg-slate-300 dark:bg-white/10 group-hover:bg-slate-400 dark:group-hover:bg-white/20 transition-colors" />
                ...
                {isTyping && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex justify-start">
                    <div className="border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#0A0C13] px-4 py-3 flex items-center gap-1.5 h-10 rounded-md shadow-md">
              ...
              {/* Input */}
              <div className="p-4 bg-transparent shrink-0 z-20 border-t border-slate-200 dark:border-white/10 pb-5 backdrop-blur-md">
                  ...
                  <div className="relative p-[1px] rounded-lg bg-gradient-to-r from-indigo-500 via-fuchsia-500 to-emerald-500 animate-[pulse_3s_ease-in-out_infinite] shadow-[0_0_30px_rgba(192,38,211,0.2)]">
                    <div className="relative bg-white dark:bg-[#080A0F] rounded-md overflow-hidden">
                      <input value={inputValue} onChange={e => setInputValue(e.target.value)} onKeyDown={handleKeyDown}
                        ...
                        className="w-full bg-transparent border-none py-4 pl-4 pr-16 text-[13px] text-foreground placeholder-slate-500 focus:outline-none" />
      ...
      {/* ━━━ WHITE CARD RISES FROM DARK — arched top, no gradient ━━━ */}
      <div className="bright-section-start w-full pb-0">

      {/* Social Proof */}
      <section className="w-full max-w-[1000px] mx-auto px-6 pt-20 pb-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-normal text-gray-900 mb-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="border border-gray-200 bg-gray-50 rounded-xl p-6">
              <p className="text-[13px] text-gray-600 leading-relaxed mb-4 italic">&ldquo;{t.quote}&rdquo;</p>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-orange-100 border border-orange-200 flex items-center justify-center">
                  <span className="text-[10px] font-bold text-orange-500">{t.name[0]}</span>
                </div>
                <div>
      ...
      {/* How It Works */}
      <section className="w-full max-w-[900px] mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-normal text-gray-900 mb-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
            How it works.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="text-center">
              <div className="w-10 h-10 rounded-full border border-orange-400 bg-orange-50 flex items-center justify-center mx-auto mb-4">
                <span className="text-orange-500 font-bold text-sm">{s.step}</span>
              </div>
              <h3 className="text-[15px] font-semibold text-gray-800 mb-2">{s.title}</h3>
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={i} className="border-b border-gray-200 pb-5">
              <h3 className="text-[14px] font-semibold text-gray-800 mb-2">{faq.q}</h3>
      ...
      <section className="w-full max-w-[900px] mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">Hatcher</h3>
            <p className="text-3xl font-bold text-gray-900 mb-1">$0<span className="text-sm font-normal text-gray-400">/mo</span></p>
            <p className="text-gray-400 text-sm mb-5">For solo builders getting started</p>
            <ul className="space-y-2.5 text-sm text-gray-500">
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Unlimited messages</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>3 projects</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>All 30 AI teammates</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Pro AI model — same quality</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Real-time chat with streaming</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Automatic task detection</li>
            </ul>
            <Link href="/login">
              <button className="w-full mt-6 py-2.5 rounded-lg border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-100 transition-colors cursor-pointer">
                Get Started
              </button>
            </Link>
          </div>
          <div className="rounded-xl border border-indigo-300 bg-indigo-50 p-6 relative">
            ...
            <p className="text-3xl font-bold text-gray-900 mb-1">$19<span className="text-sm font-normal text-gray-400">/mo</span></p>
            <p className="text-gray-400 text-sm mb-5">For builders who ship fast</p>
            <ul className="space-y-2.5 text-sm text-gray-500">
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Unlimited messages</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Unlimited projects</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>All 30 AI teammates</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Pro AI model</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Full autonomous execution</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>50 background executions/day</li>
              <li className="flex items-start gap-2"><span className="text-indigo-500 mt-0.5">&#10003;</span>Peer review + safety gates</li>
            </ul>
            <Link href="/login">
            ...
            <p className="text-xs text-gray-400 text-center mt-2">or $190/year (save 17%)</p>
          </div>
        </div>
      </section>
      ...
      {/* ━━━ FOOTER VIDEO — bright scene, no one working, mix-blend-mode zoomed out ━━━ */}
      <section className="relative overflow-hidden flex-shrink-0" style={{ background: '#ffffff', minHeight: '100vh' }}>

        {/* Video full-bleed, multiply blends with white background */}
        <video
          autoPlay loop muted playsInline
        ...
        {/* CTA at the top of the video, footer links pinned to bottom */}
        <div className="relative z-10 flex flex-col items-center justify-between min-h-[100vh] text-center px-6 pt-20 pb-10">
          {/* Top: headline + CTA grouped together */}
          <div className="flex flex-col items-center">
            <h2
              className="text-4xl md:text-5xl font-normal mb-3"
              style={{ fontFamily: "'Instrument Serif', serif", color: '#1a1a1a' }}
            >
              Every dream needs a team.
            </h2>
            <p className="text-lg mb-8" style={{ color: 'rgba(30,30,30,0.55)' }}>
              Yours is already here.
            </p>
            <Link href="/login">
              <button className="bg-orange-500 hover:bg-orange-400 text-white font-black tracking-[0.15em] uppercase text-[13px] py-5 px-12 transition-all border border-orange-400 shadow-[0_0_40px_rgba(249,115,22,0.3)] hover:shadow-[0_0_60px_rgba(249,115,22,0.5)] rounded-xl cursor-pointer">
                Meet Your Team &rarr;
              </button>
            </Link>
            <p className="text-xs mt-3" style={{ color: 'rgba(30,30,30,0.35)' }}>
              Free. No credit card. Takes 30 seconds.
            </p>
          </div>

          {/* Bottom: footer links */}
          <div className="w-full max-w-[1000px] flex flex-col md:flex-row items-center justify-between gap-4 border-t pt-6" style={{ borderColor: 'rgba(0,0,0,0.1)' }}>
            <span className="text-[12px]" style={{ color: 'rgba(30,30,30,0.3)' }}>&copy; 2026 Hatchin. All rights reserved.</span>
            <div className="flex items-center gap-6">
              <a href="/legal/privacy" className="text-[12px] hover:opacity-70 transition-opacity" style={{ color: 'rgba(30,30,30,0.35)' }}>Privacy</a>
              <a href="/legal/terms" className="text-[12px] hover:opacity-70 transition-opacity" style={{ color: 'rgba(30,30,30,0.35)' }}>Terms</a>
              <a href="mailto:hello@hatchin.ai" className="text-[12px] hover:opacity-70 transition-opacity" style={{ color: 'rgba(30,30,30,0.35)' }}>Contact</a>
            </div>
          </div>
        </div>
      </section>
