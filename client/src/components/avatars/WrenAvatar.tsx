// WrenAvatar — Wren (Copywriter) — Warm, expressive, curly hair, big smile, amber tones
import { motion } from "framer-motion";
import { AvatarWrapper, AvatarProps, eyeThinkingVariants } from "./BaseAvatar.js";

export default function WrenAvatar({ state = "idle", size = 36, className = "" }: AvatarProps) {
  return (
    <AvatarWrapper state={state} size={size} className={className}>
      <svg width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="wrenBg" cx="40%" cy="35%" r="65%">
        ...
        {/* Background circle */}
        <circle cx="18" cy="18" r="18" fill="url(#wrenBg)" />
        ...
        />
        {/* Side curls */}
        <path d="M6 20 Q4 22 5 26 Q7 23 8 21Z" fill="#4a2508" />
        <path d="M30 20 Q32 22 31 26 Q29 23 28 21Z" fill="#4a2508" />
        {/* Top curl bumps */}
        <circle cx="13" cy="8" r="3.5" fill="#4a2508" />
        <circle cx="18" cy="7" r="3.5" fill="#4a2508" />
        <circle cx="23" cy="8" r="3.5" fill="#4a2508" />
        ...
        {/* Cheek blush — amber warmth */}
        <circle cx="11.5" cy="22.5" r="2" fill="#d97706" opacity="0.35" />
        <circle cx="24.5" cy="22.5" r="2" fill="#d97706" opacity="0.35" />
      </svg>
    </AvatarWrapper>
  );
}
